...
def index():
    ...
    if request.method == "POST":
        ...
        # return redirect(url_for("index", result1=pro1, result2 = pro2, result3=pro3, result4=pro4, result5=pro5))
...
#     result5 = request.args.get("result5")
        ...
        print(explan5)
        return render_template("index.html", title1 = title1, explan1 = explan1 , url1=url1, title2 = title2, explan2 = explan2 , url2=url2, title3 = title3, explan3 = explan3 , url3=url3, title4 = title4, explan4 = explan4 , url4=url4, title5 = title5, explan5 = explan5 , url5=url5)
    return render_template("index.html")
